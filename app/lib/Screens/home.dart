import 'package:bob_hacks/Screens/add.dart';
import 'package:bob_hacks/Screens/statistics.dart';
import 'package:bob_hacks/data/model/add_date.dart';
import 'package:bob_hacks/data/utlity.dart';
  ...
  ListTile get(int index, Add_data history) {
    return ListTile(
      leading: ClipRRect(
        ...
        child: Image.asset('assets/pngs/${history.name}.png', height: 40),
      ),
      title: Text(
        history.name,
        style: TextStyle(
